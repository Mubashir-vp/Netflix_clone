...
class ContinueWatching extends StatefulWidget {
  ...
  const ContinueWatching({required this.indd});
      ...
      body: CustomScrollView(slivers: [
        SliverAppBar(
            ...
            flexibleSpace: FutureBuilder(
                ...
                builder:
                    (BuildContext context, AsyncSnapshot<PopularMovie?> snapshot) {
                  if (snapshot.hasData) {
        ...
        SliverToBoxAdapter(
          child: FutureBuilder(
              future: HttpService().popularMovie(),
              builder: (BuildContext ctx, AsyncSnapshot<PopularMovie?> snapshot) {
                if (snapshot.hasData) {
                  final data = snapshot.data!.results![widget.indd];
