...
class Upcoming_deails extends StatefulWidget {
  ...
  const Upcoming_deails({required this.indd});

  @override
  _Upcoming_deailsState createState() => _Upcoming_deailsState();
}

class _Upcoming_deailsState extends State<Upcoming_deails> {
  @override
      ...
      body: CustomScrollView(slivers: [
        SliverAppBar(
            ...
            flexibleSpace: FutureBuilder(
                ...
                builder:
                    (BuildContext context, AsyncSnapshot<Upcoming?> snapshot) {
                  if (snapshot.hasData) {
        ...
        SliverToBoxAdapter(
          child: FutureBuilder(
              future: HttpService().upComing(),
              builder: (BuildContext ctx, AsyncSnapshot<Upcoming?> snapshot) {
                if (snapshot.hasData) {
                  final data = snapshot.data!.results![widget.indd];
